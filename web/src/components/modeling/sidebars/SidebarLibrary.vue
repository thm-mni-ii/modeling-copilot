    ...
    <v-dialog v-model="dialog" max-width="760">
      <v-card>
        ...
        <v-card-text>
          ...
          <p class="text-caption text-medium-emphasis mt-4 mb-0">Compatibility checks for release changes will be added separately.</p>
        </v-card-text>
...
const openDialog = async () => {
  ...
  try {
    ...
    notifyError('The language catalog could not be loaded.')
  } finally {
    loading.value = false
  }
}
...
const selectNewLanguage = async (languageId: ApiId | null) => {
  ...
  try {
    ...
    notifyError('The releases could not be loaded.')
  }
}
...
const addLanguage = async () => {
  ...
  try {
    ...
    notifyError('The language could not be added.')
  }
}
...
const changeRelease = async (languageId: ApiId, versionId: ApiId | null) => {
  ...
  try {
    ...
    notifyError('The language release could not be changed.')
  }
}
...
const removeLanguage = async (languageId: ApiId) => {
  try {
    ...
    notifyError('The language could not be removed.')
  }
}
</script>
